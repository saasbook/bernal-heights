Feature: Filter hotspots by issue type

  As an admin, 
  I want to see all hotspots of the same issue type
  So that I can generate more informative data.
...
Scenario: Filter to only Car break-in reports
  When I check Car break-ins
  And I press "Filter"
  Then I should see "Folsom St & Ripley St"
  And I should see "4020 Folsom St"
  And I should see "105 Highland Ave"
  And I should not see "146 & 148 Bocana St"
  And I should not see "120 & 122 Bocana St"
    
Scenario: Filter to Graffiti reports
  When I uncheck Car break-ins
  And I check Graffiti
  Then I should see "146 & 148 Bocana St"
  And I should see "105 Highland Ave"
  And I should not see "Folsom St & Ripley St"
